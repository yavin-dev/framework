...
export default class ItemActionHelper extends Helper {
  @service itemActionDispatcher;
  ...
  compute([action, ...params]) {
    ...
    let itemAction = () => join(() => this.itemActionDispatcher.dispatch(actionName, ...params)),
