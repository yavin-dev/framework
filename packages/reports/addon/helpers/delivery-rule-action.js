...
export default class DeliveryRuleActionHelper extends Helper {
  @service deliveryRuleActionDispatcher;
  ...
  compute([action, ...params]) {
    ...
    let deliveryRuleAction = (...parameters) =>
        join(() => this.deliveryRuleActionDispatcher.dispatch(actionName, ...params, ...parameters)),
