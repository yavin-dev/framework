  ...
  afterInstall: function() {
    return this.addAddonsToProject({
      packages: [
        ...
        { name: 'navi-visualizations',              target: '^8.0.0'},
        ...
        var routeInfo = "\tthis.route('reports', function() {" + EOL + "\
            this.route('new');" + EOL + "\
            this.route('report', { path: '/:reportId'}, function() {" + EOL + "\
                this.route('view');" + EOL + "\
                this.route('edit');" + EOL + "\
        ...
        routeInfo += "\tthis.route('reportCollections', function() {" + EOL + "\
            this.route('collection', {path: '/:collectionId'})" + EOL + "\
        });" + EOL;

        routeInfo += "\tthis.route('print', function() {" + EOL + "\
            this.route('reports', function() {" + EOL + "\
                this.route('new');" + EOL + "\
                this.route('report', { path: '/:reportId'}, function() {" + EOL + "\
                    this.route('view');" + EOL + "\
                });" + EOL + "\
