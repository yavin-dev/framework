...
module('Integration | Component | filter values/since input', function(hooks) {
  ...
  test('it renders', function(assert) {
    ...
    assert
      ...
      .hasText('Jan 01, 2020 Include this day?', 'The since input shows the start date and checkbox');
    assert
  ...
  test('changing values', async function(assert) {
    ...
    assert
      .dom('.filter-values--since-input')
      .hasText('Jan 03, 2020 Include this day?', 'The start date changes to Jan 3');
  });
