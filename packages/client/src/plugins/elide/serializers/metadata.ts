...
import type { RawColumnType } from '../../../models/metadata/column.js';
...
import ElideDimensionMetadataModel from '../../../models/metadata/elide/dimension.js';
import { ElideDimensionMetadataPayload, ValueSourceType } from '../../../models/metadata/elide/dimension.js';
import type { Grain } from '../../../utils/date.js';
import { TableSource } from '../../../models/metadata/dimension.js';
...
export type Connection<T> = {
  edges: Edge<T>[];
  pageInfo?: any; // TODO: Better pageInfo type
};
...
export default class ElideMetadataSerializer extends NaviMetadataSerializer {
  ...
  protected createDimensionModel(payload: ElideDimensionMetadataPayload): DimensionMetadataModel {
    return new ElideDimensionMetadataModel(getInjector(this), payload);
  }
