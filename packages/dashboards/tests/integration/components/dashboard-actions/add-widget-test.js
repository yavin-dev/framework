...
test('report selector', function(assert) {
  ...
  assert.equal($('.add-widget-modal .ember-power-select-selected-item').text().trim(),
    'Create new...',
  ...
  return wait().then(() => {
    assert.deepEqual($('.add-widget-modal .ember-power-select-option').toArray().map(el => $(el).text().trim()),
      [
        "Create new...",
        "Report 1",
        "Report 2"
    ...
    assert.deepEqual($('.add-widget-modal .ember-power-select-group .ember-power-select-option').toArray().map(el => $(el).text().trim()),
      [
        "Report 1",
        "Report 2"
      ],
    ...
    assert.deepEqual($('.add-widget-modal .ember-power-select-group .ember-power-select-group-name').text().trim(),
      "My Reports",
