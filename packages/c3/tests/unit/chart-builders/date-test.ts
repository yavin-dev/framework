...
import BuilderClass from '@yavin/c3/chart-builders/date-time';
...
module('Unit | Chart Builders | Date Time', function (hooks) {
  ...
  test('weeks by year uses isoWeekYear', function (assert) {
    ...
    assert.strictEqual(data.series.length, 53, 'A data entry exists for each possible week in a year');
  ...
  test('days by month', function (assert) {
    ...
    assert.strictEqual(data.series.length, 31, 'A data entry exists for each possible day in a month');
  ...
  test('days by year', function (assert) {
    ...
    assert.strictEqual(data.series.length, 366, 'A data entry exists for each possible day in a year');
  ...
  test('months by year', function (assert) {
    ...
    assert.strictEqual(data.series.length, 12, 'A data entry exists for each possible month in a year');
  ...
  test('hours by day', function (assert) {
    ...
    assert.strictEqual(data.series.length, 24, 'A data entry exists for each hour in a day');
  ...
  test('minutes by hour', function (assert) {
    ...
    assert.strictEqual(data.series.length, 60, 'A data entry exists for each minute in a hour');
  ...
  test('seconds by minute', function (assert) {
    ...
    assert.strictEqual(data.series.length, 61, 'A data entry exists for each second in a minute');
  ...
  test('buildTooltip', function (assert) {
    ...
    assert.strictEqual(tooltip.layout, TooltipTemplate, 'Tooltip uses date template');
