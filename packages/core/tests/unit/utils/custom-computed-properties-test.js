...
test('computedSetDiff', function(assert){
  ...
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [1, 3],
    'Returns set operation A-B when B is a subset of A');
  ...
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [],
    'Returns setA when setA is empty');

  set(testInstance, 'setAProperty', [2, 7]);
  set(testInstance, 'setBProperty', []);
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [2, 7],
    'Returns setA when setB is empty');

  set(testInstance, 'setAProperty', []);
  set(testInstance, 'setBProperty', []);
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [],
    'Returns setA when setA and setB are empty');

  set(testInstance, 'setAProperty', []);
  set(testInstance, 'setBProperty', undefined);
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [],
    'Returns setA when setB is undefined'
  );
  ...
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [],
    'Returns empty set when setA is undefined'
  );
  ...
  assert.deepEqual(get(testInstance, 'setDiffProp'),
    [],
    'Returns empty set when setA and setB is undefined'
  );
});
