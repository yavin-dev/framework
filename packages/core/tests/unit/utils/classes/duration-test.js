...
import {
  parseDuration,
  isIsoDurationString
} from 'navi-core/utils/classes/duration';
...
test('Construction of duration objects', function(assert) {
  ...
  assert.equal(
    duration.getUnit(),
    'month',
    'duration object has unit as month'
  );
  ...
  assert.equal(
    duration.getUnit(),
    undefined,
    'duration object has unit as undefined'
  );
});
...
test('humanize', function(assert) {
  ...
  assert.equal(
    duration.humanize(),
    '1 Minute',
    'humanize returns "1 Hour" for duration PT1H'
  );
  ...
  assert.equal(
    duration.humanize(),
    '1 Week',
    'humanize returns "1 Week" for duration P1W'
  );
  ...
  assert.equal(
    duration.humanize(),
    '52 Weeks',
    'humanize returns "52 Weeks" for duration P52W'
  );
  ...
  assert.equal(
    duration.humanize(),
    'All',
    'humanize returns "All" for all duration'
  );
});
...
test('toString', function(assert) {
  ...
  assert.equal(
    duration.toString(),
    'P8M',
    'toString returns "P8W" for duration P8M'
  );
  ...
  assert.equal(
    duration.toString(),
    ALL,
    'toString returns ' + ALL + ' for all duration'
  );
});
...
test('compare', function(assert) {
  ...
  assert.equal(
    duration.compare('P7D'),
    0,
    'compare returns 0 when we compare P7D to P7D'
  );

  assert.equal(
    duration.compare('P1D'),
    1,
    'compare returns -1 when we compare P7D to P1D'
  );

  assert.equal(
    duration.compare('P12D'),
    -1,
    'compare returns -1 when we compare P7D to P12D'
  );

  assert.equal(
    duration.compare(ALL),
    -1,
    'compare returns -1 when we compare all duration to P7D'
  );
  ...
  assert.equal(
    duration.compare(ALL),
    0,
    'compare returns 0 when we compare all duration to all duration'
  );
});
...
test('isEqual', function(assert) {
  ...
  assert.equal(
    duration.isEqual('P12W'),
    true,
    'isEqual returns true when duration of 12 weeks is equal to P12W'
  );

  assert.equal(
    duration.isEqual('P15D'),
    false,
    'isEqual returns false when duration of 12 weeks is not equal to P15D'
  );

  duration = buildDuration(ALL);
  assert.equal(
    duration.isEqual(ALL),
    true,
    'isEqual returns true when both durations are all duration'
  );
});
...
test('isAll', function(assert) {
  ...
  assert.equal(
    ...
    false,
    'isAll returns false for duration P12W'
  );
  ...
  assert.equal(
    Duration.isAll(duration),
    true,
    'isAll returns true for all duration'
  );
  ...
  assert.equal(
    Duration.isAll(),
    false,
    'isAll returns false for null duration'
  );
});
...
test('getAllString static method', function(assert) {
  ...
  assert.equal(
    Duration.ALL,
    '__ALL__',
    'ALL static property has value __ALL__'
  );
});
...
test('all static method', function(assert) {
  ...
  assert.equal(
    duration.getValue(),
    ALL,
    'all static method returns all duration instance with value as ' + ALL
  );
  assert.equal(
    duration.getUnit(),
    undefined,
    'all static method returns all duration instance with unit as undefined'
  );
});
...
test('isDuration static method', function(assert) {
  ...
  assert.equal(
    Duration.isDuration(ALL),
    false,
    'isDuration static method returns false for string ' + ALL
  );
  assert.equal(
    Duration.isDuration('P6D'),
    false,
    'isDuration static method returns false for string P6D'
  );
  assert.equal(
    Duration.isDuration(),
    false,
    'isDuration static method returns false for undefined argument'
  );
  assert.equal(
    Duration.isDuration(null),
    false,
    'isDuration static method returns false for null argument'
  );
  ...
  assert.equal(
    ...
    true,
    'isDuration static method returns false for all duration'
  );
  ...
  assert.equal(
    Duration.isDuration(duration),
    true,
    'isDuration static method returns false for duration of P3W'
  );
});
...
test('parseDuration', function(assert) {
  ...
  assert.equal(
    value,
    1,
    'parseDuration parses PT1S and returns 1 as the value'
  );
  assert.equal(
    unit,
    'second',
    'parseDuration parses PT1S and returns second as the unit'
  );
  ...
  assert.equal(
    value,
    1,
    'parseDuration parses PT1M and returns 1 as the value'
  );
  assert.equal(
    unit,
    'minute',
    'parseDuration parses PT1M and returns minute as the unit'
  );
  ...
  assert.equal(
    value,
    1,
    'parseDuration parses PT1H and returns 1 as the value'
  );
  assert.equal(
    unit,
    'hour',
    'parseDuration parses PT1H and returns hour as the unit'
  );
  ...
  assert.equal(
    unit,
    'day',
    'parseDuration parses P7D and returns day as the unit'
  );
  ...
  assert.equal(
    value,
    12,
    'parseDuration parses P12W and returns 12 as the value'
  );
  assert.equal(
    unit,
    'week',
    'parseDuration parses P12W and returns week as the unit'
  );
  ...
  assert.equal(
    value,
    10,
    'parseDuration parses P10M and returns 10 as the value'
  );
  assert.equal(
    unit,
    'month',
    'parseDuration parses P10M and returns month as the unit'
  );
  ...
  assert.equal(
    value,
    ALL,
    'parseDuration parses ' + ALL + ' and returns ' + ALL + ' as the value'
  );
  assert.equal(
    unit,
    undefined,
    'parseDuration parses ' + ALL + ' and returns undefined as the unit'
  );
});
...
test('isIsoDurationString', function(assert) {
  ...
  assert.notOk(
    isIsoDurationString('P0W'),
    'Zero value is not a valid ISO duration'
  );
  assert.notOk(
    isIsoDurationString('P1J'),
    'Unsupported time unit is not a valid ISO duration'
  );
