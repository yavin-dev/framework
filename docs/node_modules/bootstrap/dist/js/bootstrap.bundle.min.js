...
!(function(t, e) {
  ...
  function ie(t, n, e) {
    return (
      (void 0 === e
        ...
        t.enabled &&
          Ot(e) &&
          ((n.offsets.popper = Yt(n.offsets.popper)), (n.offsets.reference = Yt(n.offsets.reference)), (n = e(n, t)));
      }),
      n
    );
  }
      ...
      modifiers: {
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            ...
            if (
              ((O =
                'bottom' === S ? ('HTML' === b.nodeName ? -b.clientHeight + C.bottom : -w.height + C.bottom) : C.top),
              (A = 'right' === D ? ('HTML' === b.nodeName ? -b.clientWidth + C.right : -w.width + C.right) : C.left),
              E && I)
            )
      ...
      return (
        ...
        (c._jQueryInterface = function(e) {
          return this.each(function() {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), p(this).data(Te, t)), 'string' == typeof e)
            ) {
      ...
      return (
        ...
        (t.show = function() {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            o.setAttribute('id', r),
              ...
              this.setContent(),
              this.config.animation && p(o).addClass(On);
            var s =
        ...
        (t.hide = function(t) {
          var e = this,
            ...
            o = function() {
              e._hoverState !== Dn && n.parentNode && n.parentNode.removeChild(n),
                e._cleanTipClass(),
        ...
        (t._enter = function(t, e) {
          ...
          (e = e || p(t.currentTarget).data(n)) ||
            ...
            t && (e._activeTrigger['focusin' === t.type ? xn : Pn] = !0),
            p(e.getTipElement()).hasClass(Nn) || e._hoverState === Dn
              ? (e._hoverState = Dn)
        ...
        (t._leave = function(t, e) {
          ...
          (e = e || p(t.currentTarget).data(n)) ||
            ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), p(t.currentTarget).data(n, e)),
            t && (e._activeTrigger['focusout' === t.type ? xn : Pn] = !1),
        ...
        (t._getConfig = function(t) {
          return (
            'number' ==
              typeof (t = l({}, this.constructor.Default, p(this.element).data(), 'object' == typeof t && t ? t : {}))
                .delay && (t.delay = { show: t.delay, hide: t.delay }),
            'number' == typeof t.title && (t.title = t.title.toString()),
            'number' == typeof t.content && (t.content = t.content.toString()),
            m.typeCheckConfig(_n, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (t._fixTransition = function() {
          ...
          null === t.getAttribute('x-placement') &&
            (p(t).removeClass(On), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (i._jQueryInterface = function(n) {
          return this.each(function() {
            ...
            if (
              ...
              (t || ((t = new i(this, e)), p(this).data(vn, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
  ...
  (p.fn[_n] = Rn._jQueryInterface),
    (p.fn[_n].Constructor = Rn),
    (p.fn[_n].noConflict = function() {
  ...
  var Fn = 'popover',
    ...
    Qn = l({}, Rn.DefaultType, { content: '(string|element|function)' }),
    Yn = 'fade',
    Vn = 'show',
    Xn = '.popover-header',
    zn = '.popover-body',
      ...
      return (
        ...
        (o.setContent = function() {
          ...
          'function' == typeof e && (e = e.call(this.element)),
            this.setElementContent(t.find(zn), e),
            t.removeClass(Yn + ' ' + Vn);
        }),
        ...
        (i._jQueryInterface = function(n) {
          return this.each(function() {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), p(this).data(Mn, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
  ...
  (p.fn[Fn] = Jn._jQueryInterface),
    (p.fn[Fn].Constructor = Jn),
    ...
    _i = (function() {
      function n(t, e) {
        ...
        (this._element = t),
          ...
          p(this._scrollElement).on(oi.SCROLL, function(t) {
            return n._process(t);
          }),
          this.refresh(),
          this._process();
          ...
          n.hasClass(ri)
            ...
            : (n.addClass(si),
              ...
              n
                ...
                .children(ci)
                .addClass(si)),
            p(this._scrollElement).trigger(oi.ACTIVATE, { relatedTarget: e });
        }),
        (t._clear = function() {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  p(window).on(oi.LOAD_DATA_API, function() {
    ...
    (p.fn[Zn] = _i._jQueryInterface),
    (p.fn[Zn].Constructor = _i),
      ...
      return (
          ...
          if (
            !(
              (this._element.parentNode &&
                ...
                p(this._element).hasClass(Ti)) ||
              p(this._element).hasClass(Ci)
            )
          ) {
            var t,
              i,
            ...
            var s = p.Event(bi.HIDE, { relatedTarget: this._element }),
              a = p.Event(bi.SHOW, { relatedTarget: i });
            if (
              (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())
            ) {
              o && (t = document.querySelector(o)), this._activate(this._element, e);
              var l = function() {
                var t = p.Event(bi.HIDDEN, { relatedTarget: n._element }),
                  e = p.Event(bi.SHOWN, { relatedTarget: i });
        ...
        (t._transitionComplete = function(t, e, n) {
          ...
          if (
            ...
            m.reflow(t),
            t.classList.contains(Si) && t.classList.add(Di),
            t.parentNode && p(t.parentNode).hasClass(wi))
          ) {
    ...
    Vi = (function() {
      ...
      return (
        (t.show = function() {
          ...
          var e = function() {
            t._element.classList.remove(qi),
              t._element.classList.add(Bi),
              p(t._element).trigger(Mi.SHOWN),
        ...
        (t.hide = function(t) {
          ...
          this._element.classList.contains(Bi) &&
            (p(this._element).trigger(Mi.HIDE),
            t
              ? this._close()
        ...
        (t.dispose = function() {
          clearTimeout(this._timeout),
            ...
            p(this._element).off(Mi.CLICK_DISMISS),
            p.removeData(this._element, ji),
            (this._element = null),
            (this._config = null);
        }),
        (t._getConfig = function(t) {
          return (
            ...
            m.typeCheckConfig(Hi, t, this.constructor.DefaultType),
            t
          );
        }),
        (t._setListeners = function() {
  ...
  (p.fn[Hi] = Vi._jQueryInterface),
    (p.fn[Hi].Constructor = Vi),
